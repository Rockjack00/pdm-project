"""This submodule contains the base/standard Wall class."""
...
@dataclass
class Wall:
    """A normal Wall for in a PDMWorld."""
    ...
    def __post_init__(self, simulation_name: Optional[str]):
        """Assign a given custom (simulation) name to this Wall.

        Args:
            simulation_name (Optional[str]): An custom name for this Wall.
        """
    ...
    def has_name(self) -> bool:
        """Check if this wall has a name already.

        Returns:
            bool: True if this Wall already has a name. Otherwise, return False.
        """
        return self._name is not None

    def has_unique_name(self) -> bool:
        """Check if this Wall has a unique (generated) name.

        Returns:
            bool: True if this Wall has a generated/unique name. Otherwise, return False.
        """
    ...
    def _register(self, number: int, name_set: set[str]) -> bool:
        ...
        Args:
            ...
            name_set (set[str]): The set of Wall names. This is used to ensure a this Wall has a unique name.
    ...
    def content_dict(self) -> dict[str, Any]:
        """The main content dicts of this Wall.

        This function generates the content dicts if they do not exist yet.

        Returns:
            dict[str, Any]: The list of content dicts
        """
        self._generate_content_dict()
    ...
    def content_dicts(self) -> list[dict[str, Any]]:
        """The content dicts of all Wall elements generated by this Wall.

        This function generates the content dicts if they do not exist yet.

        Returns:
            list[dict[str, Any]]: The list of content dicts
        """
    ...
    def color(self) -> list[float]:
        ...
        Returns:
            list[float]: The color in RGBA order.
        """
        self._generate_content_dict()
